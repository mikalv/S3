...
class Config {
    ...
    _getConfig() {
        ...
        if (config.replicationGroupToken !== undefined) {
            assert(typeof config.replicationGroupToken === 'string',
                'bad config: replicationGroupToken must be a string');
            this.replicationGroupToken = config.replicationGroupToken;
        } else {
            this.replicationGroupToken = 'RG001';
        }
